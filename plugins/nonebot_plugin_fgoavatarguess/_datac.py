CHARA_NAME = {
    ...
    1002: ["阿尔托莉雅·潘德拉贡","阿尔托利亚","呆毛","saber","棉被","吾王","阿尔托莉雅"],
    1003: ["阿尔托莉雅·潘德拉贡(Alter)","黑呆","黑无毛","黑SABER"],
    1004: ["阿尔托莉雅·潘德拉贡〔Lily〕","莉莉","白SABER","lily"],
    1005: ["尼禄·克劳狄乌斯","唔呣","罗马之花","红SABER", "尼禄"],
    1006: ["齐格飞","飞哥","对不起先生","七个肺"],
    1007: ["盖乌斯·尤利乌斯·恺撒","凯撒","胖尼禄","凯胖", "恺撒"],
    1008: ["阿蒂拉","大王","B提拉","彩笔","阿提拉"],
    1009: ["吉尔·德·雷","剑元帅","贞德厨", "吉尔德雷"],
    1010: ["骑士迪昂","百合剑","迪昂"],
    1011: ["卫宫","巨侠","emiya","红茶","红a"],
